...
const date = Yup.date() .nullable() .default(null) .required("Session Date is required.");
...
const end_date = Yup.date() .nullable() .default(null) .required("End Date of batch is required.");
const program = Yup.string().required("Program for the batch is required.");
const start_date = Yup.date() .nullable() .default(null) .required("Start Date of batch is required.");
