...
const website = Yup.string().required("Website of college is required."); // eslint-disable-line no-unused-vars
...
const address_line = Yup.object({    // eslint-disable-line no-unused-vars
    state,
    medha_area,
    address,
    pin_code,
