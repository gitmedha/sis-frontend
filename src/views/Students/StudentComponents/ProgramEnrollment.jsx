  ...
  const handleGenerateCertificate = async () => {
    try {
      ...
      if (data.programEnrollment) {
       ...
       ('CERTIFICATE_GENERATION_ERROR: ', error);
    } finally {
  ...
  const handleDeleteCertificate = async () => {
    try {
      ...
      if (data.programEnrollment) {
       ...
       ('CERTIFICATE_DELETE_ERROR: ', error);
    } finally {
      setLoadingCertificationButton(false);
    }
  }
          ...
          <FileStyled>
            <div className="row">
              ...
              <div className="col-md-6 col-sm-12">
                ...
                <DetailField label="Program Name" className="capitalize" value={programEnrollment&&programEnrollment.batch&&programEnrollment.batch.program&&programEnrollment.batch.program.name&&programEnrollment.batch.program.name.toLowerCase()} />
              </div>
              <div className="col-md-6 col-sm-12">
