      ...
      <Modal.Body className="bg-white">
        ...
        <div className="row">
          <div className="col-md-6 col-sm-12">
            ...
            <DetailField label="Certification Generated on" value={programEnrollment.medha_program_certificate ? moment(programEnrollment.medha_program_certificate.created_at).format("DD MMM YYYY") : ''} />
          </div>
          <div className="col-md-6 col-sm-12">
            <DetailField label="Certificate" value={programEnrollment.medha_program_certificate ? <a href={urlPath(programEnrollment.medha_program_certificate.url)} target="_blank" className="c-pointer"><FaDownload size="20" color="#6C6D78" /></a> : ''} />
          </div>
        </div>
