                    ...
                    <tbody>
                      {props.notUploadedData.map((obj, i) => (
                        <tr key={i}>
                          ...
                          <td className={obj?.start_date.notFound ? "text-danger" : ""}>{obj.start_date.value ?obj.start_date.valu :obj.start_date ?obj.start_date:"please add start date"}</td>
                          <td className={obj?.end_date.notFound ? "text-danger" : ""}>{obj.end_date.value ?obj.end_date.value :obj.end_date ?obj.end_date:"please add start date"}</td>
