    ...
    data.forEach((item, index) => {
      ...
      if (
        ...
        notFoundData.push({
          ...
          specify_others: mentorDomainCheck ? newItem["Specify Others (If Mentor's domain is 'others')"] || "" : "",
        ...
        formattedData.push({
          ...
          social_media_profile_link: newItem["Social Media Profile Link"] || "",
          medha_area: newItem["Medha Area"] || "",
          specify_others: newItem["Specify Others (If Mentor's domain is 'others')"] || "",
          status: newItem["Status"] || "",
          program_name: newItem["Medha Program Name"] || "",
          contact: newItem["Contact"] || "",
          createdby: createdby,
