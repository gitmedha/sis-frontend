...
import StudentForm from "./OperationComponents/Operationform";
import Operationform from "./OperationComponents/Operationform";

const tabPickerOptions = [
  { title: "User Opts Activity", key: "my_data" },
  { title: "User Tot", key: "useTot" },
...
const Operations= (props) => {
  ...
  const getStudents = async (status ='All', selectedTab, limit = paginationPageSize, offset = 0, sortBy = 'created_at', sortOrder = 'desc') => {
    ...
    .then(data => {
      setOpts([{"Created At":"2023-04-19T12:18:24.383286Z","Organization":"NHPC Limited Tanakpur","Activity Type":"Industry Talk/Expert Talk","Institution":304,"Updated At":null,"End Date":"2020-06-19","Designation":"Junior Engineer","Start Date":"2020-06-19","Assigned To":129,"Other Links":"0","Topic":"Career challenges and opportunities during/post pandemic of covid-19","Donor":false,"Batch":1006,"ID":2200,"Updated By":null,"Students Attended":40,"Created By":2,"State":"Uttar Pradesh","Area":"Bareilly (City)","Guest":"Mr. Pradeep Kumar Dubey"},
