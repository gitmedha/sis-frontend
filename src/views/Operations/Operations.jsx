...
const Operations= (props) => {
  ...
  const [opts, setOpts] = useState([
    {
      ...
      "2200": 2201,
      "FIELD3": "",
      "2023-04-19 17:48:24.383286+05:30": "2023-04-19 17:48:24.383286+05:30",
      "FIELD5": "",
      "Industry Talk": {
         "Expert Talk": "Industry Talk/Expert Talk"
      },
      "Bareilly (City)": "Gorakhpur (City)",
      "Uttar Pradesh": "Uttar Pradesh",
      "2020-06-19": [
         "2020-07-06",
         "2020-07-06"
      ],
      "Career challenges and opportunities during": {
         "post pandemic of covid-19": "Goonj fellowship and NGO work"
      },
      "f": "f",
      "Mr. Pradeep Kumar Dubey": "Mr. Shushil Yadav",
      "Junior Engineer": "State Head(U.P)",
      "NHPC Limited Tanakpur": "Goonj"
   },
    {
      "0": 0,
      "2": 2,
      ...
      "FIELD5": "",
      "Industry Talk": {
         "Expert Talk": "Workshop/Training Session/Activity (In/Off campus)"
      },
      "Bareilly (City)": "Varanasi (City)",
      "Uttar Pradesh": "Uttar Pradesh",
      "2020-06-19": [
         "2020-07-14",
         "2020-07-14"
      ...
      "Career challenges and opportunities during": {
         "post pandemic of covid-19": "Covid-19: An Awareness Quiz"
      },
      "f": "f",
      "Mr. Pradeep Kumar Dubey": "Manju Chetri",
      "Junior Engineer": "Manager",
      "NHPC Limited Tanakpur": "Medha"
   }]);
  ...
  //   })
  //   .then(data => {
  //     setOpts(data?.data?.data?.studentsConnection.values);
  ...
  return (
    <Collapse title="OPERATION" type="plain" opened={true}>
      <Styled>
        <div className="row m-1">
          ...
          {/* <div className="d-flex flex-column flex-md-row justify-content-between align-items-center mb-2">
            ...
            <Tabs  onTabChange={handleStudentStatusTabChange} />
          ...
          <Table  columns={columns} data={opts}  fetchData={fetchData}  /> 
